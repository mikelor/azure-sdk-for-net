...
namespace Microsoft.Azure.Batch
{
    ...
    public partial class NodePlacementConfiguration : ITransportObjectProvider<Models.NodePlacementConfiguration>, IPropertyMetadata
    {
        ...
        {
            this.Policy = UtilitiesInternal.MapEnum<Models.NodePlacementPolicyType, Common.NodePlacementPolicyType>(protocolObject.NodePlacementPolicyType);
        }
        ...
        Models.NodePlacementConfiguration ITransportObjectProvider<Models.NodePlacementConfiguration>.GetTransportObject()
        {
            ...
            {
                NodePlacementPolicyType = UtilitiesInternal.MapEnum<Common.NodePlacementPolicyType, Models.NodePlacementPolicyType>(this.Policy),
            };
