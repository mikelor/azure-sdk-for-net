...
namespace Microsoft.Azure.Batch
{
    ...
    public partial class VMExtension : ITransportObjectProvider<Models.VMExtension>, IPropertyMetadata
    {
        ...
        {
            public readonly PropertyAccessor<boolean> AutoUpgradeMinorVersionProperty;
            ...
            {
                this.AutoUpgradeMinorVersionProperty = this.CreatePropertyAccessor<boolean>(nameof(AutoUpgradeMinorVersion), BindingAccess.Read | BindingAccess.Write);
            ...
            public PropertyContainer(Models.VMExtension protocolObject) : base(BindingState.Bound)
            {
                this.AutoUpgradeMinorVersionProperty = this.CreatePropertyAccessor(
                    UtilitiesInternal.CreateObjectWithNullCheck(protocolObject.AutoUpgradeMinorVersion, o => new boolean(o)),
        ...
        Models.VMExtension ITransportObjectProvider<Models.VMExtension>.GetTransportObject()
        {
            ...
            {
                AutoUpgradeMinorVersion = UtilitiesInternal.CreateObjectWithNullCheck(this.AutoUpgradeMinorVersion, (o) => o.GetTransportObject()),
                Name = this.Name,
