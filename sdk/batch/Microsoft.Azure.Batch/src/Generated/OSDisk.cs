...
namespace Microsoft.Azure.Batch
{
    ...
    public partial class OSDisk : ITransportObjectProvider<Models.OSDisk>, IPropertyMetadata
    {
        ...
        {
            public readonly PropertyAccessor<Common.DiffDiskSettings> EphemeralOSDiskSettingsProperty;

            public PropertyContainer() : base(BindingState.Unbound)
            {
                this.EphemeralOSDiskSettingsProperty = this.CreatePropertyAccessor<Common.DiffDiskSettings>(nameof(EphemeralOSDiskSettings), BindingAccess.Read | BindingAccess.Write);
            }
            ...
            public PropertyContainer(Models.OSDisk protocolObject) : base(BindingState.Bound)
            {
                this.EphemeralOSDiskSettingsProperty = this.CreatePropertyAccessor(
                    UtilitiesInternal.MapEnum<Models.DiffDiskSettings, Common.DiffDiskSettings>(protocolObject.EphemeralOSDiskSettings),
        ...
        /// </summary>
        public Common.DiffDiskSettings EphemeralOSDiskSettings
        {
        ...
        Models.OSDisk ITransportObjectProvider<Models.OSDisk>.GetTransportObject()
        {
            ...
            {
                EphemeralOSDiskSettings = UtilitiesInternal.MapEnum<Common.DiffDiskSettings, Models.DiffDiskSettings>(this.EphemeralOSDiskSettings),
            };
